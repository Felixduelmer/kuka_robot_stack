...
public slots:
  ...
  void onClickedpbtnPrepareForScan();
  void onClickedpbtnRunUSScan();
  void onClickedpbtnLoadSweepPosition();
  void onClickedpbtnLoadSweepImage();
  void onClickedpbtnReplaceWithLabel();
  void onClickedpbtnExtractBoneSurface();
  void onClickedpbtbGetUSPointCloud();
  void onClickedpbtnShowSurface();
